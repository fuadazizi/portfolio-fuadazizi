...
export default function Salesproduct() {
	return (
		<div id="sp-gallery">
			<GalleryFrame
				title="SALESPRODUCT"
				subtitle="Detikcom | 2022"
				logo="./assets/images/logos/salesproduct.png"
			>
				<div className="ideas">
					<h2 className="gallery-section-title"> Ideas </h2>
					<p className="fs-regular text-justify">
						There is a lot of information, database, and other stuff that needed
						by all teams for supporting their job. So, the idea is to provide
						them with a toolkit website where it can contains all this
						information. The website named “Salesproduct”. This website created
						by Ads Designer Team to help other team by providing them with data
						and information for developing and advertising ads detikcom.
					</p>
					<Row className="d-flex justify-content-center gy-4">
						<Col xs={10} lg={6}>
							<PopupCard type="right">
								<img
									src="assets/images/gallery/sp1.png"
									alt="sp1"
									width="100%"
								/>
							</PopupCard>
						...
						<Col xs={10} lg={6}>
							<PopupCard type="left">
								<img
									src="assets/images/gallery/sp2.png"
									alt="sp1"
									width="100%"
								/>
							</PopupCard>
